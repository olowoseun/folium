    ...
    max-w-7xl justify-evenly px-10 mx-auto items-center'>
      ...
      <div className='flex flex-col space-y-7'>
        <h4 className='text-2xl font-semibold text-center pt-24'>
          Looking for something? <span className='underline decoration-[#3752f1]'>Let&apos;s talk.</span>
        </h4>
        ...
        <button type='submit' className='bg-[#3752f1] py-3 px-10 text-black font-bold text-md rounded-md'>
            Submit
          </button>
        </form>
      </div>
